...
const HeroSection = () => {
  ...
  useEffect(() => {
    heroTl
      ...
      .to(
        heroTextRef?.current,
        { opacity: 1, duration: 1, ease: "Power1.easeIn" },
        "<"
      );
  ...
  return (
    <section className="relative w-full h-[50vh] md:h-[70vh]">
      ...
      <div
        ref={heroImageRef}
        className="hero_image absolute md:left-[100%] md:-translate-x-[100%] left-0 top-0 w-full h-full z-[-1]  md:max-w-[70%]  shadow-xl"
      >
        <Image
